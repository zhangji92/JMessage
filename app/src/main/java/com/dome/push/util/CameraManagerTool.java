...
public final class CameraManagerTool {
    ...
    private CameraManagerTool(Application context) {
    ...
    private static CameraManagerTool INSTANCE;

    public static CameraManagerTool getInstance(Application context) {
        if (INSTANCE == null) {
            synchronized (CameraManagerTool.class) {
                if (INSTANCE == null) {
                    INSTANCE = new CameraManagerTool(context);
                }
            }
        }
        return INSTANCE;
