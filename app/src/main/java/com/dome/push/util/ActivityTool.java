 ...
 * Package:        com.dome.push.util
 * ClassName:      ActivityTool
 * Description:    描述
 * Author:         张继
 * CreateDate:     19-12-10 下午3:52
 * UpdateUser:     更新者
 * UpdateDate:     19-12-10 下午3:52
 * UpdateRemark:   更新说明
 * Version:        1.0
 */
public class ActivityTool {
    ...
    public static boolean isActivityExists(@NonNull final String pkg,
        ...
        return !(ApplicationTool.getApp().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(ApplicationTool.getApp().getPackageManager()) == null ||
                ApplicationTool.getApp().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static void startActivity(@NonNull final Class<? extends Activity> clz) {
        Context context = ApplicationTool.getTopActivityOrApp();
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(ApplicationTool.getTopActivityOrApp(), null, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls,
                                     @Nullable final Bundle options) {
        startActivity(ApplicationTool.getTopActivityOrApp(), null, pkg, cls, options);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     @NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(ApplicationTool.getTopActivityOrApp(), extras, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     ...
                                     @NonNull final String cls,
                                     @Nullable final Bundle options) {
        startActivity(ApplicationTool.getTopActivityOrApp(), extras, pkg, cls, options);
    }
    ...
    public static boolean startActivity(@NonNull final Intent intent) {
        return startActivity(intent, ApplicationTool.getTopActivityOrApp(), null);
    }
    ...
    public static boolean startActivity(@NonNull final Intent intent,
                                        @Nullable final Bundle options) {
        return startActivity(intent, ApplicationTool.getTopActivityOrApp(), options);
    }
    ...
    public static void startActivityForResult(@NonNull final Fragment fragment,
                                              @NonNull final Class<? extends Activity> clz,
                                              final int requestCode) {
        startActivityForResult(fragment, null, ApplicationTool.getApp().getPackageName(), clz.getName(),
                requestCode, null);
    }
    ...
    public static void startActivityForResult(@NonNull final Bundle extras,
                                              ...
                                              @NonNull final Class<? extends Activity> clz,
                                              final int requestCode) {
        startActivityForResult(fragment, extras, ApplicationTool.getApp().getPackageName(), clz.getName(),
                requestCode, null);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents) {
        startActivities(intents, ApplicationTool.getTopActivityOrApp(), null);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents,
                                       @Nullable final Bundle options) {
        startActivities(intents, ApplicationTool.getTopActivityOrApp(), options);
    }
    ...
    public static void startLauncherActivity() {
        startLauncherActivity(ApplicationTool.getApp().getPackageName());
    }
    ...
    public static List<Activity> getActivityList() {
        return ApplicationTool.getActivityList();
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(ApplicationTool.getApp().getPackageName());
    }
    ...
    public static List<String> getMainActivities() {
        return getMainActivities(ApplicationTool.getApp().getPackageName());
    }
    ...
    public static Activity getTopActivity() {
        return ApplicationTool.getActivityLifecycle().getTopActivity();
    }
    ...
    public static boolean isActivityExistsInStack(@NonNull final Activity activity) {
        List<Activity> activities = ApplicationTool.getActivityList();
    ...
    public static void finishAllActivities(final boolean isLoadAnim) {
        List<Activity> activityList = ApplicationTool.getActivityList();
    ...
    public static Drawable getActivityIcon(@NonNull final Class<? extends Activity> clz) {
        return getActivityIcon(new ComponentName(ApplicationTool.getApp(), clz));
    }
    ...
    public static Drawable getActivityLogo(@NonNull final Class<? extends Activity> clz) {
        return getActivityLogo(new ComponentName(ApplicationTool.getApp(), clz));
    }
    ...
    private static boolean startActivity(final Intent intent,
        ...
        if (!isIntentAvailable(intent)) {
            Log.e("ActivityApplicationTool", "intent is unavailable");
            return false;
        }
        if (!(context instanceof Activity)) {
    ...
    private static boolean startActivityForResult(final Intent intent,
        ...
        if (fragment.getActivity() == null) {
            Log.e("ActivityApplicationTool", "Fragment " + fragment + " not attached to Activity");
            return false;
        }
        if (options != null && Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
