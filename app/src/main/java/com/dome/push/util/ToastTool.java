...
public class ToastTool {
    ...
    public static void normal(@NonNull String message) {
        normal(ApplicationTool.getApp(), message, Toast.LENGTH_SHORT, null, false).show();
    }

    public static void normal(@NonNull String message, Drawable icon) {
        normal(ApplicationTool.getApp(), message, Toast.LENGTH_SHORT, icon, true).show();
    }

    public static void normal(@NonNull String message, int duration) {
        normal(ApplicationTool.getApp(), message, duration, null, false).show();
    }

    public static void normal(@NonNull String message, int duration, Drawable icon) {
        normal(ApplicationTool.getApp(), message, duration, icon, true).show();
    }

    public static Toast normal(@NonNull String message, int duration, Drawable icon, boolean withIcon) {
        return custom(ApplicationTool.getApp(), message, icon, DEFAULT_TEXT_COLOR, duration, withIcon);
    }

    public static void warning(@NonNull String message) {
        warning(ApplicationTool.getApp(), message, Toast.LENGTH_SHORT, true).show();
    }

    public static void warning(@NonNull String message, int duration) {
        warning(ApplicationTool.getApp(), message, duration, true).show();
    }

    public static Toast warning(@NonNull String message, int duration, boolean withIcon) {
        return custom(ApplicationTool.getApp(), message, getDrawable(ActivityTool.getTopActivity(), R.mipmap.ic_error_outline_white_48dp), DEFAULT_TEXT_COLOR, WARNING_COLOR, duration, withIcon, true);
    }

    public static void info(@NonNull String message) {
        info(ApplicationTool.getApp(), message, Toast.LENGTH_SHORT, true).show();
    }

    public static void info(@NonNull String message, int duration) {
        info(ApplicationTool.getApp(), message, duration, true).show();
    }

    public static Toast info(@NonNull String message, int duration, boolean withIcon) {
        return custom(ApplicationTool.getApp(), message, getDrawable(ActivityTool.getTopActivity(), R.mipmap.ic_info_outline_white_48dp), DEFAULT_TEXT_COLOR, INFO_COLOR, duration, withIcon, true);
    }

    public static void success(@NonNull String message) {
        success(ApplicationTool.getApp(), message, Toast.LENGTH_SHORT, true).show();
    }

    public static void success(@NonNull String message, int duration) {
        success(ApplicationTool.getApp(), message, duration, true).show();
    }

    public static Toast success(@NonNull String message, int duration, boolean withIcon) {
        return custom(ApplicationTool.getApp(), message, getDrawable(ActivityTool.getTopActivity(), R.mipmap.ic_check_white_48dp), DEFAULT_TEXT_COLOR, SUCCESS_COLOR, duration, withIcon, true);
    }

    public static void error(@NonNull String message) {
        error(ApplicationTool.getApp(), message, Toast.LENGTH_SHORT, true).show();
    }
    ...
    public static void error(@NonNull String message, int duration) {
        error(ApplicationTool.getApp(), message, duration, true).show();
    }

    public static Toast error(@NonNull String message, int duration, boolean withIcon) {
        return custom(ApplicationTool.getApp(), message, getDrawable(ActivityTool.getTopActivity(), R.mipmap.ic_clear_white_48dp), DEFAULT_TEXT_COLOR, ERROR_COLOR, duration, withIcon, true);
    }
    ...
    public static Toast custom(@NonNull Context context, @NonNull String message, Drawable icon, @ColorInt int textColor, @ColorInt int tintColor, int duration, boolean withIcon, boolean shouldTint) {
        ...
        final View toastLayout = LayoutInflater.from(context).inflate(R.layout.layout_toast, null);
    ...
    public static void showToastShort(String str) {
        Toast.makeText(ApplicationTool.getApp(), str, Toast.LENGTH_SHORT).show();
    }
    ...
    public static void showToastShort(int resId) {
        Toast.makeText(ApplicationTool.getApp(), ApplicationTool.getApp().getString(resId), Toast.LENGTH_SHORT).show();
    }
    ...
    public static void showToastLong(String str) {
        Toast.makeText(ApplicationTool.getApp(), str, Toast.LENGTH_LONG).show();
    }
    ...
    public static void showToastLong(int resId) {
        Toast.makeText(ApplicationTool.getApp(), ApplicationTool.getApp().getString(resId), Toast.LENGTH_LONG).show();
    }
    ...
    public static void showToast(String msg) {
        if (mToast == null) {
            mToast = Toast.makeText(ApplicationTool.getApp(), msg, Toast.LENGTH_LONG);
        } else {
            mToast.setText(msg);
        }
        mToast.show();
    ...
    public static void showToast(int resId) {
        if (mToast == null) {
            mToast = Toast.makeText(ApplicationTool.getApp(), ApplicationTool.getApp().getString(resId), Toast.LENGTH_LONG);
        } else {
            mToast.setText(ApplicationTool.getApp().getString(resId));
        }
        mToast.show();
    }
