...
public class RxTitle extends RelativeLayout {
    //*******************************************控件start******************************************
    //根布局
    ...
    private void initView(final Context context, AttributeSet attrs) {
        ...
        try {
            ...
            //标题颜色
            mTitleColor = a.getColor(R.styleable.RxTitle_titleColor, getResources().getColor(android.R.color.white));
            //标题字体大小
            mTitleSize = a.getDimensionPixelSize(R.styleable.RxTitle_titleSize, ScreenTool.dip2px(20));
            ...
            //左边图标
            mLeftIcon = a.getResourceId(R.styleable.RxTitle_leftIcon, R.mipmap.back_black);
            //右边图标
            mRightIcon = a.getResourceId(R.styleable.RxTitle_rightIcon, R.mipmap.set);
            //左边图标是否显示
            mLeftIconVisibility = a.getBoolean(R.styleable.RxTitle_leftIconVisibility, false);
            //右边图标是否显示
            ...
            //左边字体颜色
            mLeftTextColor = a.getColor(R.styleable.RxTitle_leftTextColor, getResources().getColor(android.R.color.white));
            //标题字体大小
            mLeftTextSize = a.getDimensionPixelSize(R.styleable.RxTitle_leftTextSize, ScreenTool.dip2px(8));
            ...
            //右边字体颜色
            mRightTextColor = a.getColor(R.styleable.RxTitle_rightTextColor, getResources().getColor(android.R.color.white));
            //标题字体大小
            mRightTextSize = a.getDimensionPixelSize(R.styleable.RxTitle_rightTextSize, ScreenTool.dip2px(8));
    ...
    private void initAutoFitEditText() {
        ...
        // 可以在布局添加；
        mTvTitle.setMaxHeight(ScreenTool.dip2px(55f));
        //不要忘记以编程方式添加最小文本大小
