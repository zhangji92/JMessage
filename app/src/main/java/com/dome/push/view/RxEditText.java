...
public class RxEditText extends AppCompatEditText {
    ...
    private static final String TAG = RxEditText.class.getName();
    ...
    private void replaceLastChar(@NonNull String chr, SpannableString spannable) {
        ...
        if (selStart == selEnd && selStart > 0
                ...
                && msg.getSpans(selStartBefore, selEnd, RxEditText.TagSpan.class).length == 0) {
    ...
    public void appendMention(String... mentions) {
        ...
        RxEditText.matchMention(spannable);
    ...
    public void appendTopic(String... topics) {
        ...
        RxEditText.matchTopic(spannable);
    ...
    private class ZanyInputConnection extends InputConnectionWrapper {
        ...
        public boolean sendKeyEvent(KeyEvent event) {
            if (event.getAction() == KeyEvent.ACTION_DOWN
                ...
                if (!RxEditText.this.mTagSpanTextWatcher.checkKeyDel())
                    return false;
            }
    ...
    public interface OnKeyArrivedListener {
        boolean onMentionKeyArrived(RxEditText editText);

        boolean onTopicKeyArrived(RxEditText text);
    }
